    ...
    <div className="flex flex-row">
      <div className="w-full flex flex-col md:p-[60px] p-10 md:pl-[100px]">
        ...
        <section className="flex flex-col mt-[80px] text-[#ffffff] gap-11">
          ...
          <Image src={ImageBlank} alt="" className="self-center object-contain md:px-[60px] rounded-3xl" />
          <div className="flex md:flex-row flex-col gap-4">
            <button className="flex flex-row justify-between px-[20px] py-[24px] w-full bg-ninjack-bg-gray border-ninjack-line-gray border-[1px] rounded-[6px]"><span>関連リンク（自由テキスト）</span> <Image src={IconNext} alt="" className="self-center"/></button>
            <button className="flex flex-row justify-between px-[20px] py-[24px] w-full bg-ninjack-bg-gray border-ninjack-line-gray border-[1px] rounded-[6px]"><span>関連リンク（自由テキスト）</span> <Image src={IconNext} alt="" className="self-center"/></button>
            <button className="flex flex-row justify-between px-[20px] py-[24px] w-full bg-ninjack-bg-gray border-ninjack-line-gray border-[1px] rounded-[6px]"><span>関連リンク（自由テキスト）</span> <Image src={IconNext} alt="" className="self-center"/></button>
          </div>
          ...
          <Image src={ImageVideo} alt="" className="self-center object-contain md:px-[60px] rounded-3xl" />
        ...
        <Image src={ImageMap} alt="" className="w-full md:px-[60px] object-contain" />
          <div className="flex flex-row md:gap-3 gap-2 mt-[80px] md:px-[128px] ">
            <button className="flex flex-row gap-2 text-[#ffffff] bg-[#06C755] rounded-[4px] py-[13px] w-full justify-center text-[12px]"><Image src={ImageLine} alt="" className="self-center" /> LINEで送る </button>
            <button className="flex flex-row gap-2 text-[#ffffff] border-[1px] border-[#ffffff] rounded-[4px] py-[13px] w-full justify-center text-[12px]"><Image src={ImageX} alt="" className="self-center" /> ポスト </button>
            <button className="flex flex-row gap-2 text-[#ffffff] bg-[#1977F2] rounded-[4px] py-[13px] w-full justify-center text-[12px]"><Image src={ImageFacebook} alt="" className="self-center" /> シェア </button>
          </div>
        ...
        <section className="mt-[120px] flex flex-col gap-7">
          <div className="flex space-x-4 items-center">
            ...
            <h2 className="md:text-[36px] text-[28px] text-ninjack-white">関連する商品・忍具</h2>
          </div>
          <div className="grid md:grid-cols-4 grid-cols-2 md:gap-[40px] gap-8">
          {itemLists.map((item: any , index:any) => {
              return (
                <ItemItem
                key={index}
                  image={item.image}
        ...
        <section className="mt-[90px] flex flex-col gap-7">
          <div className="flex space-x-4 items-center">
            ...
            <h2 className="md:text-[36px] text-[28px] text-ninjack-white">関連する体験・修行</h2>
          </div>
          ...
          <section className="flex flex-col gap-4 md:hidden">
            {subActivities.map((activity: any, index) => {
              return (
                <ActivitySubList
                key={index}
                  image={activity.image}
...
const itemList = [
  {
    ...
    content: "れはじゅうもじですこれはじゅうもじですれはじゅうもじですこれはじゅうもじですれはじゅうもじですこれはじゅうもじですれはじゅうもじですこれは…",
    price: 1000,
  },
  {
    image: ImageNinja,
