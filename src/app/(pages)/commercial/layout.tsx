...
export default function CommercialPageLayout({
  children,
}: {
...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_BASE_URL + "commercial" || "http://localhost:3000"
  ),
  title: "特定商取引法の表示 - 忍者ポータルサイト「Ninjack」",
  description:
  ...
  openGraph: {
    ...
    description:
      "すべての忍者をJackする。忍者ですべてをJackする。Ninjack.jpは、忍者体験・スポット・アイテム・フィクション・現代忍者・最新ニュース・研究情報など、忍者に関するあらゆる情報を網羅した“忍者総合ポータルサイト”です。 「すべての忍者をJackする。忍者ですべてをJackする。」をコンセプトに、忍者に関する多彩なコンテンツを提供しています。",
    url:
      process.env.NEXT_PUBLIC_BASE_URL + "commercial" ||
      "http://localhost:3000",
