        ...
        <div className="flex flex-row">
            <div className="w-full flex flex-col md:p-[60px] md:pl-[100px] p-8">
                ...
                <section className="flex flex-col ">
                    ...
                    <p className="text-ninjack-white text-[28px] font-bold mb-2">タイトルタイトルタイトルタイトルタイトルタイトルタイトル</p>
                    <KeywordsDetail
                        keywords={[
                ...
                <section className="mt-[120px] flex flex-col gap-7">
                    <div className="flex space-x-4 items-center">
                        <h2 className="md:text-[36px] text-[28px] text-ninjack-white">おすすめのマガジン</h2>
                    </div>
