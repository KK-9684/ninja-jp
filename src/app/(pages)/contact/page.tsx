...
export default function ContactPage() {
  return (
    <div className="flex flex-col w-[100%] md:w-[720px] md:max-w-[720px] md:mx-auto mt-[100px]">
      ...
      <div className="md:p-[40px] md:w-[100%] bg-ninjack-white mx-6 rounded-md p-6 box-border">
