  ...
  return (
    ...
    <div className="md:flex hidden space-x-1.5 items-center">
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-ninjack-white text-[44px] leading-none font-semibold">{counts}+</p>
      </div>
    </div>
    <div className="flex md:hidden space-x-1 items-center">
      ...
      <div className="flex flex-col justify-center">
        <p className="text-ninjack-text-gray">{label}</p>
        <p className="text-ninjack-white text-[26px] leading-none font-semibold">{counts}+</p>
      </div>
    </div>
    </div>
  );
