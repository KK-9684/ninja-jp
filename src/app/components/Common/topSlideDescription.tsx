...
const TopSlideDescription = ({ title, content }: TopSlideDescriptionProps) => {
  return (
    <div className="flex flex-col justify-end space-y-5 absolute bottom-0 left-0 p-5 w-[100%] md:w-[400px] box-inherit bg-gradient-to-t from-[rgba(97,33,146,0.9)] to-[rgba(97,33,146,0.0)] rounded-[0_0_10px_10px] h-[200px]">
